...
function inputColumnsForDoc4(ticket, score, nextEvaluationDate, nonconformities, ticketParticipants = []) {
  ...
  return {
    ...
    N: { label: 'Địa chỉ đánh giá NCC', value: ticket.snapshot_evaluation_address || '' },
    O: { label: 'Địa chỉ đánh giá đơn vị liên kết/gia công', value: ticket.snapshot_linked_facility_address || '' },
    ...
    S: { label: 'Sản phẩm đánh giá', value: ticket.snapshot_product_name || ticket.product_group || '' },
...
function buildReportContext(db, ticket, options = {}) {
  ...
  const doc4 = {
    ...
    related_information: {
      ...
      evaluation_address: ticket.snapshot_evaluation_address || '',
      linked_evaluation_address: ticket.snapshot_linked_facility_address || '',
    },
    scope: {
      product: ticket.snapshot_product_name || '',
    ...
    supplier_introduction: {
      ...
      products: ticket.snapshot_product_name || ticket.product_group || '',
  ...
  return {
    ...
    address: ticket.supplier_address || ticket.snapshot_evaluation_address || '',
