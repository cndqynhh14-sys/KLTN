...
function buildWhere(filters = {}, scope = null) {
  ...
  const filterMap = {
    ...
    mch2: ['mch2', "COALESCE(NULLIF(TRIM(t.mch2), ''), NULLIF(TRIM(sm.mch2), ''))"],
    mch3: ['mch3', "COALESCE(NULLIF(TRIM(t.mch3), ''), NULLIF(TRIM(sm.mch3), ''))"],
  };
...
function evaluationRows(db, filters = {}, scope = null) {
  ...
  return db.prepare(`
    SELECT
      ...
      COALESCE(NULLIF(TRIM(t.evaluation_address), ''), NULLIF(TRIM(sm.evaluation_address), ''), NULLIF(TRIM(t.supplier_address), ''), NULLIF(TRIM(sm.address), '')) AS evaluation_address,
      COALESCE(NULLIF(TRIM(t.linked_facility_address), ''), NULLIF(TRIM(sm.linked_facility_address), '')) AS linked_facility_address,
      ...
      COALESCE(NULLIF(TRIM(t.cmc_owner), ''), NULLIF(TRIM(sm.cmc_owner), '')) AS cmc_owner,
      COALESCE(NULLIF(TRIM(t.cmc_head), ''), NULLIF(TRIM(sm.cmc_head), '')) AS cmc_head,
      ...
      COALESCE(NULLIF(TRIM(t.mch2), ''), NULLIF(TRIM(sm.mch2), '')) AS mch2,
      COALESCE(NULLIF(TRIM(t.mch3), ''), NULLIF(TRIM(sm.mch3), '')) AS mch3,
      COALESCE(NULLIF(TRIM(t.product_group), ''), NULLIF(TRIM(sm.product_group), '')) AS product_group,
      COALESCE(NULLIF(TRIM(t.product_name), ''), NULLIF(TRIM(sm.product_name), '')) AS product_name,
