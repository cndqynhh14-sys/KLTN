(function initActionRegistry(root, factory) {
  ...
  const ACTION_REGISTRY = Object.freeze([
    ...
    define('evaluation.corrective_action', 'Thêm yêu cầu khắc phục', { icon: 'add', placement: 'form', permission: 'EVALUATION.SCORE', entity: 'EVALUATION', backend_action: 'score', mutation: true, success: 'Đã thêm yêu cầu khắc phục.', event: 'evaluation.workflow.transitioned' }),
    ...
    define('authorization.user_roles_save', 'Lưu phân vai người dùng', { icon: 'save', variant: 'primary', placement: 'form', permission: 'USER.MANAGE', entity: 'AUTHORIZATION', reason: { required: true }, mutation: true, success: 'Đã lưu phân vai.', event: 'user.authorization.changed' }),
    ...
    define('question_version.clone_draft', 'Tạo Draft bộ câu hỏi', { icon: 'copy', placement: 'form', permission: 'QUESTION_TEMPLATE.MANAGE', entity: 'QUESTION_TEMPLATE', mutation: true, success: 'Đã tạo Draft bộ câu hỏi.', event: 'question.template.changed' }),
    ...
    define('report_template.create_draft', 'Clone thành Draft mẫu báo cáo', { short_label: 'Clone Draft', icon: 'copy', placement: 'page', permission: 'REPORT_TEMPLATE.MANAGE', entity: 'REPORT_TEMPLATE', backend_action: 'report_template.create_draft', mutation: true, success: 'Đã tạo Draft mẫu báo cáo.', event: 'report.template.changed' }),
    define('report_template.save_draft', 'Lưu Draft mẫu báo cáo', { short_label: 'Lưu Draft', icon: 'save', variant: 'primary', placement: 'form', permission: 'REPORT_TEMPLATE.MANAGE', entity: 'REPORT_TEMPLATE', allowed_statuses: ['DRAFT'], backend_action: 'report_template.save_draft', mutation: true, success: 'Đã lưu Draft mẫu báo cáo.', event: 'report.template.changed' }),
    ...
    define('scoring_policy.create_draft', 'Clone thành Draft chính sách tính điểm', { short_label: 'Clone Draft', icon: 'copy', placement: 'page', permission: 'SCORING_POLICY.MANAGE', entity: 'SCORING_POLICY', backend_action: 'scoring_policy.create_draft', mutation: true, success: 'Đã tạo Draft chính sách tính điểm.', event: 'scoring.policy.changed' }),
    define('scoring_policy.save_draft', 'Lưu Draft chính sách tính điểm', { short_label: 'Lưu bản nháp', icon: 'save', variant: 'primary', placement: 'form', permission: 'SCORING_POLICY.MANAGE', entity: 'SCORING_POLICY', allowed_statuses: ['DRAFT'], backend_action: 'scoring_policy.save_draft', mutation: true, success: 'Đã lưu Draft chính sách tính điểm.', event: 'scoring.policy.changed' }),
    ...
    define('scoring_policy.publish', 'Publish chính sách tính điểm', { short_label: 'Publish', icon: 'check', variant: 'primary', placement: 'form', permission: 'SCORING_POLICY.PUBLISH', entity: 'SCORING_POLICY', allowed_statuses: ['IN_REVIEW'], backend_action: 'scoring_policy.publish', confirm: { required: true, include_object: true, consequence: 'Phiên bản trở thành chính sách mặc định cho phiếu mới; phiếu cũ giữ version đã pin.' }, mutation: true, success: 'Đã publish chính sách tính điểm.', event: 'scoring.policy.changed' }),
