(function initNavigationManifest(root, factory) {
  ...
  const NAVIGATION_MANIFEST = Object.freeze([
    ...
    define({ id: 'admin-users', kind: 'route', parent: 'admin-people-access', route: '/admin/users', view: 'view-admin',
      label: 'Danh sách nhân sự', short_label: 'Nhân sự', description: 'Thêm, khóa, mở lại và điều chỉnh quyền đang áp dụng cho tài khoản.',
    ...
    define({ id: 'admin-roles', kind: 'route', parent: 'admin-people-access', route: '/admin/roles', view: 'view-admin',
      label: 'Vai trò công việc', short_label: 'Vai trò', description: 'Quản lý các nhóm quyền theo công việc.',
    ...
    define({ id: 'admin-personnel-import', kind: 'route', parent: 'admin-people-access', route: '/admin/personnel-import', view: 'view-admin',
      label: 'Nhập danh sách nhân sự', short_label: 'Nhập nhân sự', description: 'Nhập nhiều nhân sự và gán vào vai trò công việc phù hợp.',
    ...
    define({ id: 'admin-approval-assignments', kind: 'route', parent: 'admin-people-access', route: '/admin/approval-assignments', view: 'view-admin',
      label: 'Người phê duyệt', short_label: 'Người duyệt', description: 'Chọn ai sẽ phê duyệt ở từng bước và phạm vi dữ liệu.',
      icon: 'approval', order: 40, active_match: ['/admin/approval-assignments'], permissions: ['USER.MANAGE'], permission_mode: 'all',
      feature_flag: null, mobile_priority: null, breadcrumbs: ['administration', 'admin', 'admin-people-access'], contextual: false,
    ...
    define({ id: 'admin-business-config', kind: 'group', parent: 'admin', route: null, view: null,
      label: 'Cấu hình nghiệp vụ', short_label: 'Nghiệp vụ', description: 'Quản lý cấu hình phiên bản cho câu hỏi, báo cáo và chính sách tính điểm.',
    ...
    define({ id: 'admin-scoring-policies', kind: 'route', parent: 'admin-business-config', route: '/admin/scoring-policies', view: 'view-admin',
      label: 'Chính sách tính điểm', short_label: 'Tính điểm', description: 'Quản lý phiên bản công thức, khoảng xếp loại, điểm trừ và quy tắc kết luận.',
    ...
    define({ id: 'admin-system-operations', kind: 'group', parent: 'admin', route: null, view: null,
      label: 'Vận hành hệ thống', short_label: 'Vận hành', description: 'Theo dõi nhật ký hệ thống và UAT khi được bật.',
